          ...
          <div className="space-y-12">
            ...
            {isPending && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {Array.from({ length: 4 }).map((_, i) => (
                  <div key={i} className="rounded-[2.5rem] border border-border bg-card p-2">
                    <div className="aspect-[16/10] w-full rounded-[2rem] bg-muted animate-pulse mb-6" />
            ...
            {isError && (
              <div className="rounded-3xl border border-destructive/20 bg-destructive/5 p-10 text-center">
                <h3 className="text-xl font-bold mb-2">We couldn't load the projects</h3>
